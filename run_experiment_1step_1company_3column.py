...
if __name__ == "__main__":
    ...
    dataset_pickle_path = 'dataset/pickle/dataset_1step_1company_3col.pkl'
    ...
    model = simple_lstm.get_model(50, (10, 3))
    model = train.train_model(model, X_train, y_train, X_val, y_val)

    y_hats = infer.infer_testset(model, X_test, y_test, (10, 3))
